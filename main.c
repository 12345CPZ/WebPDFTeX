...
const char *ptexbanner = " (PDFTeX 0.3.0 compiled with WASM)";
const char *DEFAULT_FMT_NAME = " pdftexWasm.fmt";
const char *DEFAULT_DUMP_NAME = "pdftexWasm";
string versionstring = " (PDFTeX 0.3.0 WASM Version)";
int exit_code;
jmp_buf jmpenv;
...
int main(int argc, char **argv) {
  ...
  if (strlen(bootstrapcmd) == 0) {
    fprintf(stderr, "Usage: PDFTeX WASM foo.tex\n");
    return -1;
  }
...
int main(int argc, char **argv) {
    printf("pdfTeX WASM Engine Loaded\n");
}
